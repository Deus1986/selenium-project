...
class TestAdverstisingInSomeonePublicGroup:
    allure.title("Adverstising_in_someone_public_group")
    allure.severity(severity_level="blocker")

    def test_adverstising_in_someone_public_group(self, driver):
        ...
        comment = Users.USER_COMMENT_4
        description = OKData.CALLA_CAPTIN_SAFARI_DESCRIPTION
        body = {
            ...
            "photos": [
                {
                    "url": OKData.CALLA_CAPTIN_SAFARI_PHOTO,
