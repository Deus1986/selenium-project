...
def test_adverstising_in_someone_public_group():
    ...
    comment = Users.userComment4
    description = OKData.callaCaptinSafariDescription
    body = {
            ...
            "photos": [
                {
                    "url": OKData.callaCaptinSafariPhoto,
